    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl p-6 sm:p-8 md:p-12 mb-8 sm:mb-12 border border-purple-100">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand/20 rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-xl sm:text-2xl">💡</span>
              </div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Why I Created QuizNotes</h2>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 sm:p-8 border border-gray-200">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 text-center">What Can You Contact Me About?</h3>
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="flex items-start gap-2 sm:gap-3">
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-brand rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Feature Requests</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Ideas for new quiz types, tools, or features</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Bug Reports</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Found an issue? Let me know so I can fix it</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">School Partnerships</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Bulk licensing and institutional pricing</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">General Questions</h4>
                  <p className="text-xs sm:text-sm text-gray-600">How to use features, pricing, or anything else</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Feedback</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Your thoughts on what's working or what could be better</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Just Say Hi!</h4>
                  <p className="text-xs sm:text-sm text-gray-600">I'd love to hear from fellow music educators</p>
                </div>
              </div>
            </div>
          </div>
