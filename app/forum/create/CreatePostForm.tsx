...
export default function CreatePostForm({ tags }: CreatePostFormProps) {
...
`code`"
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="text-sm font-semibold text-blue-900 mb-2">💡 Tips for a great post:</h3>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          onClick={() => router.back()}
          disabled={isSubmitting}
          className="px-8 py-3 bg-white text-gray-700 font-semibold rounded-lg border-2 border-gray-300 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Cancel
        </button>
      </div>
